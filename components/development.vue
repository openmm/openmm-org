  ...
  <div>
    ...
    <v-container class="d-flex flex-wrap justify-center">
      ...
      <v-card class="ma-2" width="300">
        ...
        <v-card-text>
        OpenMM was supported (July 2021 - March 2025) by the <a href="https://www.nigms.nih.gov/" target="blank">National Institute of General Medical Sciences</a> of the <a href="https://www.nih.gov/" target="blank">National Institutes of Health</a> under award number <a href="https://reporter.nih.gov/search/XnJncpjxUkSKiIFzf9su9A/project-details/10979091" target="blank">R01GM140090</a>.
        </v-card-text>
      </v-card>
