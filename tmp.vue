...
<div class="jumbotron jumbtron-color">
  ...
  <h3>Part of the Omnia Suite</h3>
  <div> The cornerstone for the Omnia suite of tools for predictive biomolecular simulation.  <a href="https://omniamd.squarespace.com/"> Learn more </a> </div>

    <h3>Funding</h3>
    <div>OpenMM is currently (May 2020-Apr 2021) funded by a <a href="https://chanzuckerberg.com/eoss/proposals/openmm-key-infrastructure-for-biomolecular-modeling-and-simulation">Chan Zuckerberg Initiative Essential Open Source Software for Science grant</a> </div>
